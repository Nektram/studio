...
- Nuestras defensas:
  ...
  * Construyendo red colonia por colonia
  * Único modelo sin comisiones
- Iconos de escudo/fortaleza
- Contraste: "Empresa gringa desde Estados Unidos vs conocimiento local"

### Slide 9: INVERSIÓN E IMPACTO
- Título: "$135,000 MXN para Hacer Esto en Grande"
- Gráfico de pie del uso de fondos:
  * 50% Marketing en San Luis y otras ciudades
  * 25% Equipo de operaciones
  * 25% Formalización legal
- Timeline de crecimiento:
  * Año 1: 60 restaurantes = $460,000 pesos
  * Año 3: 500 restaurantes = $3.8 millones
- Nota: "La tecnología ya está terminada"

### Slide 10: VISIÓN Y CIERRE
- Título: "No Es Solo un Negocio"
- Mensaje central: "Cada peso que ahorramos a un restaurante mexicano se queda en México, no se va a Silicon Valley"
- Proyección: "$3.8M MXN en 3 años con 500 restaurantes"
- Visión: "Tecnología mexicana para restaurantes mexicanos"
- Call to action: "¿Qué opinan?"
- Logo Studio Mars y Go Delivery
- ## CONTENIDO ESPECÍFICO POR SLIDE

### Datos y Estadísticas Exactas
- Competencia: Hasta 42% de comisión (35% + impuestos)
- Nuestra comisión: 0% - Solo $13 pesos/día fijo
- Mercado mexicano: 600,000 restaurantes total (INEGI)
- En apps delivery: 150,000 restaurantes
- Ahorro mensual: $12,600 pesos vs competencia
- Proyección Año 1: $500,000 MXN (50 restaurantes)
- Proyección Año 3: $3.8 millones MXN (500 restaurantes)
- Operación actual: San Luis Potosí
- App móvil drivers: En revisión Google Play Store
- Experiencia Mario: Dueño de restaurante + repartidor ($14/viaje)

### Textos Específicos
- Usar exactamente el contenido del pitch ejecutivo
- Mantener coherencia con documentos estratégicos
- Incluir call-to-actions específicos
...
- Logo de Studio Mars y Go Delivery en cada slide
- Colores exactos según brand guidelines
- Tipografía consistente en toda la presentación
- Elementos visuales coherentes
- Presentador: Mario Rico, estudiante UTAN San Luis
- Proyecto: "Studio Mars: Diseño Web y Delivery para Restaurantes en SLP"
- ### **Animaciones Específicas**
1. **Logo de entrada**: Zoom + fade elegante
2. **Números crecientes**: Counter animado para métricas
3. **Barras de progreso**: Crecimiento desde 0 hasta valor final
4. **Mapas**: Aparición progresiva de puntos
5. **Transiciones**: Slide suave con parallax sutil
- Body and headline font: 'PT Sans' for a modern yet warm and accessible feel.
- Clean and modern icons representing restaurants, delivery, and savings. The logos for Studio Mars (favicon: https://res.cloudinary.com/drswibb0s/image/upload/v1755501656/SIGLAS_SM_Logo_q04n1v.png, logo: https://res.cloudinary.com/drswibb0s/image/upload/v1755501663/Logo_Completo_tpoaox.png) and Go Delivery (isologo: https://res.cloudinary.com/drswibb0s/image/upload/v1758686485/logo_vectorizado_xglfzi.svg, favicon: https://res.cloudinary.com/drswibb0s/image/upload/v1758686485/icon_p9vwts.png) should be prominently featured.
- Carousel-style landing page to present key information in a structured manner. Slides will match the slides the user requested.
- Subtle transitions between slides, such as a fade-in or slide-in effect, to provide a smooth and engaging experience for the viewer.